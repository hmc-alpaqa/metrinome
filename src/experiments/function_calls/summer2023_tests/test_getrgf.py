...
class DataCollector:
    ...
    def __init__(self) -> None:
        ...
        self.getrgf_computer = fcn_call_path_complexity.FunctionCallPathComplexity(
            log)
    ...
    def collect(self) -> None:
        ...
        for graph_name, graph in graphs.items():
            ...
            try:
                with Timeout(4000):
                    getrgfapc = self.getrgf_computer.evaluate(
                        graph, graphs)
                    print(getrgfapc)
            ...
            data = data[["graph_name", "getrgfapc", "getrgfapc_time",
