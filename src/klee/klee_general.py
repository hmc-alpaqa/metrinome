    ...
    def parseCFileList(filepath):
        ...
        with open(filepath, "r") as file:
            ...
            for line in lines:
                ...
                # Split the line into file path and function name
                file_path, function_name = line.rsplit(' ', 1)

                # Extract the directory and file name
                dir_path, file_name_with_extension = file_path.rsplit('/', 1)
...
#     klee_path = "/app/build/bin/klee" # location of the klee command
#     src_filepath = "/app/code/tests/cFiles/C-master/sorting/" # location of source files to run klee on, end with a slash
#     filepath = "/app/code/tests/cFiles/benchmark/kleeversions/kleetest_fall2023/" # directory to create (if it doesn't exist) and put all results/created files in
