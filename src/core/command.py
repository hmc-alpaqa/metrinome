...
class Command:
    ...
    def do_klee_replay(self, flags, file_name: str) -> None:
        """
    ...
    def do_import(self, flags, *args_list: str) -> None:
        """
        ...
        print('yeah', flags.recursive_mode, args_list)
        for full_path in args_list:
    ...
    def do_list(self, flags, list_typename: str) -> None:
        """
    ...
    def do_metrics(self, flags, name: str) -> None:
        """
    ...
    def do_show_klee(self, flags, obj_type: ObjTypes, names: List[str]) -> bool:
    ...
    def do_show(self, flags, obj_typename: str, arg_name: str) -> None:
        """
    ...
    def do_klee_to_bc(self, flags, name: str) -> None:
    ...
    def do_to_klee_format(self, flags, file_path: str) -> None:
        """
    ...
    def do_klee(self, flags, name: str, *extra_args: str) -> None:
        """
    ...
    def _klee_known_files(self, flags, name: str, *extra_args: str) -> None:
    ...
    def do_quit(self, flags) -> None:
        """Quit the path complexity repl."""
        readline.write_history_file()
        raise SystemExit

    def do_export(self, flags, export_typename: str, name: str) -> None:
        """
    ...
    def do_cd(self, flags, new_path: str) -> None:
    ...
    def do_mkdir(self, flags, dirname: str) -> None:
        """Make a new directory."""
        subprocess.check_call(["mkdir", "-p", dirname])

    def do_mv(self, flags, name_one: str, name_two: str) -> None:
        """Move a file from one directory to another."""
        subprocess.check_call(["mv", name_one, name_two])

    def do_rm(self, flags, *names: str) -> None:
    ...
    def do_pwd(self, flags) -> None:
        """Print out the current working directory."""
        self.logger.v_msg(self.curr_path)

    def do_delete(self, flags, obj_type: str, name: str) -> None:
        """
