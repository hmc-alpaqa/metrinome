    ...
    with open(file, 'r') as old_f:
        ...
        with open((file.split('.')[0]) + "-auto-inline.c", "w") as new_f:
            ...
            for line in old_f:
                ...
                line_inline = False 
                if ((line.startswith('int')) or (line.startswith('void')) or (line.startswith('double')) or (line.startswith('bool'))
                or (line.startswith('float')) or (line.startswith('char')) or (line.startswith('static'))):
