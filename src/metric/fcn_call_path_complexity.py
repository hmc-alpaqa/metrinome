...
class FunctionCallPathComplexity(ABC):
    ...
    def gammaFunction(self, edgelist, call_list):
        ...
        # init all symbols from full_sys
        # from V0_0 to V0_20
        ...
        # full_sys = [-T0 + V0_0*x, -V0_0 + V0_1*x + V0_2*x, -V0_1 + x, 2*T0*V0_3*x - V0_2, -V0_3 + V0_4*x + V0_5*x, -V0_4 + V0_5*x, V0_10*x - V0_5 + V0_6*x, -V0_6 + V0_7*x + V0_8*x, -V0_7 + V0_9*x, -V0_8 + V0_9*x, V0_3*x - V0_9, -V0_10 + V0_11*x, -V0_11 + V0_12*x + V0_13*x, V0_11*x - V0_12, -V0_13 + V0_14*x, -V0_14 + V0_15*x + V0_16*x, V0_14*x - V0_15, -V0_16 + V0_17*x, -V0_17 + V0_18*x + V0_20*x, -V0_18 + V0_19*x, V0_17*x - V0_19, -V0_20 + x]
        # full_sys = [-T0 + V0_0*x, -V0_0 + V0_1*x + V0_2*x, -V0_1 + x, T0**2*V0_3*x - V0_2, -V0_3 + V0_4*x + V0_5*x, -V0_4 + V0_5*x, V0_10*x - V0_5 + V0_6*x, -V0_6 + V0_7*x + V0_8*x, -V0_7 + V0_9*x, -V0_8 + V0_9*x, V0_3*x - V0_9, -V0_10 + V0_11*x, -V0_11 + V0_12*x + V0_13*x, V0_11*x - V0_12, -V0_13 + V0_14*x, -V0_14 + V0_15*x + V0_16*x, V0_14*x - V0_15, -V0_16 + V0_17*x, -V0_17 + V0_18*x + V0_20*x, -V0_18 + V0_19*x, V0_17*x - V0_19, -V0_20 + x]
