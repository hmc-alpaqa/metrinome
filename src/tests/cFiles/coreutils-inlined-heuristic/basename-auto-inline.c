...
__attribute__((always_inline)) inline static void remove_suffix(char *name, const char *suffix) {
  char *np;
  const char *sp;
...
__attribute__((always_inline)) inline static void perform_basename(const char *string, const char *suffix,
                             bool use_nuls) {
