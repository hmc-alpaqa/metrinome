...
__attribute__((always_inline)) inline extern void set_fields(const char *fieldstr, unsigned int options);

/* frees memory allocated by set_fields() */
__attribute__((always_inline)) inline extern void reset_fields(void);
