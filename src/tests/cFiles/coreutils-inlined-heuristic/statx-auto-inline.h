...
__attribute__((always_inline)) static inline struct timespec statx_timestamp_to_timespec(
    struct statx_timestamp tsx) {
  struct timespec ts;
...
__attribute__((always_inline)) static inline void statx_to_stat(struct statx *stx, struct stat *stat) {
