...
__attribute__((always_inline)) inline static void writeline(struct linebuffer const *line, FILE *stream, int class) {
  switch (class) {
    case 1:
...
__attribute__((always_inline)) inline static void check_order(struct linebuffer const *prev,
...
__attribute__((always_inline)) inline static void compare_files(char **infiles) {
