...
__attribute__((always_inline)) inline int rpl_rename(const char *, const char *);
#undef rename
#define rename rpl_rename
#endif

__attribute__((always_inline)) inline bool copy(char const *src_name, char const *dst_name, bool nonexistent_dst,
          const struct cp_options *options, bool *copy_into_self,
          bool *rename_succeeded);

__attribute__((always_inline)) inline extern bool set_process_security_ctx(char const *src_name, char const *dst_name,
                                     mode_t mode, bool new_dst,
                                     const struct cp_options *x);

__attribute__((always_inline)) inline extern bool set_file_security_ctx(char const *dst_name, bool process_local,
                                  bool recurse, const struct cp_options *x);

__attribute__((always_inline)) inline void dest_info_init(struct cp_options *);
__attribute__((always_inline)) inline void src_info_init(struct cp_options *);

__attribute__((always_inline)) inline void cp_options_default(struct cp_options *);
__attribute__((always_inline)) inline bool chown_failure_ok(struct cp_options const *) _GL_ATTRIBUTE_PURE;
