...
__attribute__((always_inline)) inline static void rm_option_init(struct rm_options *x) {
...
__attribute__((always_inline)) inline static bool do_move(const char *source, const char *dest,
...
__attribute__((always_inline)) inline static bool movefile(char *source, char *dest, bool dest_is_dir,
                     const struct cp_options *x) {
  bool ok;
