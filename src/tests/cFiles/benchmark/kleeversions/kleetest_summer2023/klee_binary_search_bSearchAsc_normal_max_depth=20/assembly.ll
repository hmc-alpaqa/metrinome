; ModuleID = '/app/code/tests/cFiles/benchmark/kleeversions/kleetest_summer2023/binary_search_bSearchAsc_.bc'
source_filename = "/app/code/tests/cFiles/benchmark/kleeversions/kleetest_summer2023/binary_search_bSearchAsc_.c"
...
@.str.6 = private unnamed_addr constant [33 x i8] c"db6e48a858d6439c94afa713540c4542\00", align 1
@.str.7 = private unnamed_addr constant [33 x i8] c"4b9ac7d35bbd4877bfdb9c24417618d6\00", align 1
@.str.8 = private unnamed_addr constant [33 x i8] c"622986e2e7f04174b974eeb2ae72d2ae\00", align 1
...
define i32 @main() #0 !dbg !112 {
  ...
  %5 = bitcast [1000 x i32]* %2 to i8*, !dbg !120
  call void @klee_make_symbolic(i8* %5, i64 4000, i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.6, i32 0, i32 0)), !dbg !121
  call void @llvm.dbg.declare(metadata i32* %3, metadata !122, metadata !DIExpression()), !dbg !123
  %6 = bitcast i32* %3 to i8*, !dbg !124
  call void @klee_make_symbolic(i8* %6, i64 4, i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.7, i32 0, i32 0)), !dbg !125
  %7 = load i32, i32* %3, align 4, !dbg !126
  %8 = icmp slt i32 %7, -1, !dbg !128
  %9 = load i32, i32* %3, align 4, !dbg !129
  %10 = icmp sgt i32 %9, 1024, !dbg !130
  %or.cond = or i1 %8, %10, !dbg !131
  br i1 %or.cond, label %11, label %12, !dbg !131
...
; <label>:12:                                     ; preds = %0
  ...
  %13 = bitcast i32* %4 to i8*, !dbg !136
  call void @klee_make_symbolic(i8* %13, i64 4, i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.8, i32 0, i32 0)), !dbg !137
  %14 = load i32, i32* %4, align 4, !dbg !138
  %15 = icmp slt i32 %14, -1, !dbg !140
  %16 = load i32, i32* %4, align 4, !dbg !141
  %17 = icmp sgt i32 %16, 1024, !dbg !142
  %or.cond3 = or i1 %15, %17, !dbg !143
  br i1 %or.cond3, label %18, label %19, !dbg !143
...
; <label>:19:                                     ; preds = %12
  %20 = getelementptr inbounds [1000 x i32], [1000 x i32]* %2, i32 0, i32 0, !dbg !146
  %21 = load i32, i32* %3, align 4, !dbg !147
  %22 = load i32, i32* %4, align 4, !dbg !148
  %23 = call i32 @bSearchAsc(i32* %20, i32 %21, i32 %22), !dbg !149
  store i32 %23, i32* %1, align 4, !dbg !150
  br label %24, !dbg !150

; <label>:24:                                     ; preds = %19, %18, %11
  %25 = load i32, i32* %1, align 4, !dbg !151
  ret i32 %25, !dbg !151
}
...
!1 = !DIFile(filename: "/app/code/tests/cFiles/benchmark/kleeversions/kleetest_summer2023/binary_search_bSearchAsc_.c", directory: "/app/code")
!2 = !{}
...
!114 = !{!11}
!115 = !DILocalVariable(name: "A", scope: !112, file: !1, line: 6, type: !116)
...
!122 = !DILocalVariable(name: "s", scope: !112, file: !1, line: 9, type: !11)
...
!134 = !DILocalVariable(name: "data", scope: !112, file: !1, line: 14, type: !11)
...
!140 = !DILocation(line: 16, column: 11, scope: !139)
!141 = !DILocation(line: 16, column: 20, scope: !139)
!142 = !DILocation(line: 16, column: 24, scope: !139)
!143 = !DILocation(line: 16, column: 16, scope: !139)
!144 = !DILocation(line: 17, column: 4, scope: !145)
!145 = distinct !DILexicalBlock(scope: !139, file: !1, line: 16, column: 32)
!146 = !DILocation(line: 18, column: 20, scope: !112)
!147 = !DILocation(line: 18, column: 23, scope: !112)
!148 = !DILocation(line: 18, column: 26, scope: !112)
!149 = !DILocation(line: 18, column: 9, scope: !112)
!150 = !DILocation(line: 18, column: 2, scope: !112)
!151 = !DILocation(line: 19, column: 1, scope: !112)
