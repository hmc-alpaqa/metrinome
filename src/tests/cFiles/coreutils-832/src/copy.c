...
bool set_process_security_ctx(char const *src_name, char const *dst_name,
...
bool set_file_security_ctx(char const *dst_name, bool process_local,
...
static bool source_is_dst_backup(char const *srcbase, struct stat const *src_st,
                                 char const *dst_name) {
