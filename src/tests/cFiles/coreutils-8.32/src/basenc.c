...
static int base64_length_wrapper(int len) { return BASE64_LENGTH(len); }

static void base64_decode_ctx_init_wrapper(struct base_decode_context *ctx) {
  base64_decode_ctx_init(&ctx->ctx.base64);
}

static bool base64_decode_ctx_wrapper(struct base_decode_context *ctx,
                                      const char *restrict in, size_t inlen,
                                      char *restrict out, size_t *outlen) {
...
static void base64url_encode(const char *restrict in, size_t inlen,
                             char *restrict out, size_t outlen) {
...
static bool isbase64url(char ch) {
...
static bool base64url_decode_ctx_wrapper(struct base_decode_context *ctx,
                                         const char *restrict in, size_t inlen,
                                         char *restrict out, size_t *outlen) {
...
static int base32_length_wrapper(int len) { return BASE32_LENGTH(len); }

static void base32_decode_ctx_init_wrapper(struct base_decode_context *ctx) {
  base32_decode_ctx_init(&ctx->ctx.base32);
}

static bool base32_decode_ctx_wrapper(struct base_decode_context *ctx,
                                      const char *restrict in, size_t inlen,
                                      char *restrict out, size_t *outlen) {
...
static void base32hex_encode(const char *restrict in, size_t inlen,
                             char *restrict out, size_t outlen) {
...
static bool base32hex_decode_ctx_wrapper(struct base_decode_context *ctx,
                                         const char *restrict in, size_t inlen,
                                         char *restrict out, size_t *outlen) {
  prepare_inbuf(ctx, inlen);
...
static void base16_encode(const char *restrict in, size_t inlen,
                          char *restrict out, size_t outlen) {
  while (inlen--) {
    unsigned char c = *in;
    *out++ = base16[c >> 4];
...
static bool base16_decode_ctx(struct base_decode_context *ctx,
                              const char *restrict in, size_t inlen,
                              char *restrict out, size_t *outlen) {
...
static void z85_encode(const char *restrict in, size_t inlen,
                       char *restrict out, size_t outlen) {
  int i = 0;
...
static bool z85_decode_ctx(struct base_decode_context *ctx,
                           const char *restrict in, size_t inlen,
                           char *restrict out, size_t *outlen) {
  bool ignore_lines = true; /* for now, always ignore them */
...
inline static bool isbase2(char ch) { return ch == '0' || ch == '1'; }

static int base2_length(int len) { return len * 8; }

inline static void base2msbf_encode(const char *restrict in, size_t inlen,
                                    char *restrict out, size_t outlen) {
  while (inlen--) {
    unsigned char c = *in;
    for (int i = 0; i < 8; i++) {
...
inline static void base2lsbf_encode(const char *restrict in, size_t inlen,
                                    char *restrict out, size_t outlen) {
  while (inlen--) {
    unsigned char c = *in;
    for (int i = 0; i < 8; i++) {
...
static bool base2lsbf_decode_ctx(struct base_decode_context *ctx,
                                 const char *restrict in, size_t inlen,
                                 char *restrict out, size_t *outlen) {
  bool ignore_lines = true; /* for now, always ignore them */
...
static bool base2msbf_decode_ctx(struct base_decode_context *ctx,
                                 const char *restrict in, size_t inlen,
                                 char *restrict out, size_t *outlen) {
  bool ignore_lines = true; /* for now, always ignore them */
