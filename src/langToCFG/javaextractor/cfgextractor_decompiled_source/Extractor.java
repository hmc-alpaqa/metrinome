...
public class Extractor
{
    public static void main(final String[] args) {
        ...
        final CommandLineParser comParser = (CommandLineParser)new PosixParser();
        ...
        final Collection<File> classFiles = (Collection<File>)FileUtils.listFiles(classFolder, (IOFileFilter)new RegexFileFilter("[^\\s]+\\.class$"), DirectoryFileFilter.DIRECTORY);
            ...
            try {
                ...
                if (ComOptions.DB_MODE) {
                    if (!ComOptions.SINGLE_METHOD_MODE) {
                        ...
                        cv = new CFGClassVisitor((ClassVisitor)cw);
                        cr.accept(cv, 0);
                    }
                    else {
