...
You need to update ANDROID_SDK_HOME
Do not update any other variable unless you know what you are doing
...
class Env:
    ...
    CFG_EXTRACTOR = os.path.abspath(os.path.join(     PROJECT_PATH, 'java', 'cfgextractor.jar' ) )
