# python /app/code/experiments/function_calls/summer2023_tests/test_apc.py
...
python /app/code/experiments/function_calls/summer2023_tests/test_getrgf.py #must run this in order for mergeTestResult to work
